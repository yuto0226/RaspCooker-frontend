  ...
  <div>
    ...
    <div v-else>
      ...
      >
        <tbody>
          <tr>
            <td class="border border-gray-300 dark:border-gray-700 px-4 py-2 font-semibold">
              File Path
            </td>
      ...
      <div class="flex gap-4">
        <div class="w-1/2">
          ...
          <pre
            class="h-100 p-4 rounded border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-sm overflow-auto max-h-96"
